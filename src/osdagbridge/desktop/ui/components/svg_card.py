"""
SVG card widgets for OsdagBridge GUI.
...
# Image area inside a card, in logical pixels
IMAGE_WIDTH = 120
IMAGE_HEIGHT = 80
...
class SvgCard(QFrame):
    ...
    def __init__(self, key, title, svg_path, parent=None):
        ...
        # Fit the artwork into the card's image area whatever size it ships at,
        # rendered at 2x so it stays crisp on HiDPI screens.
        ...
        self.svg_widget.setFixedSize(IMAGE_WIDTH, IMAGE_HEIGHT)
