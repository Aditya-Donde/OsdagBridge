...
# Stiffener design summary — single source for report Table 5.7 and the Steel
# Design Details tab's stiffener table. Written by store_design_results() both
# flat (controlling girder) and per-girder as "<key>.G{n}.M1". Values are stored
# presentation-neutral; each consumer formats them.
KEY_SD_STIFF_METHOD     = "steeldesign.details.stiffener_summary.method"
KEY_SD_STIFF_INT_THICK  = "steeldesign.details.stiffener_summary.int_thickness"
KEY_SD_STIFF_INT_SPACING= "steeldesign.details.stiffener_summary.int_spacing"
KEY_SD_STIFF_INT_WIDTH  = "steeldesign.details.stiffener_summary.int_width"
KEY_SD_STIFF_END_THICK  = "steeldesign.details.stiffener_summary.end_thickness"
KEY_SD_STIFF_END_WIDTH  = "steeldesign.details.stiffener_summary.end_width"
KEY_SD_STIFF_END_SPACING= "steeldesign.details.stiffener_summary.end_spacing"     # input-echoed (not designed)
...
KEY_SD_DEFL_LIVE_RAW    = "steeldesign.deflection.raw.live_mm"   # only for report (pre-camber)
KEY_SD_DEFL_TOTAL_RAW   = "steeldesign.deflection.raw.total_mm"  # only for report (pre-camber)
KEY_SD_DEFL_DL_RAW      = "steeldesign.deflection.raw.dl_mm"     # only for report (pre-camber)
