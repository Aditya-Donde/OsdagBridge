...
\hline
1 & Structural Steel (IS 2062) for Girders & MT &  & \\
\hline
2 & Structural Steel for Cross Bracings & MT &  & \\
\hline
3 & Concrete (M40) for Deck Slab & Cu.m &  & \\
\hline
4 & Reinforcement Steel (Fe 500) & MT &  & \\
\hline
5 & Shear Stud Connectors & Nos &  & \\
\hline
\end{longtable}
"""
