        ...
        "Cross Bracing": {
            ...
            "section_inputs": [
                ...
                },
                {
                    ...
                    "default": "Bolted",
                    "bind": "cross_connection_type_combo",
                },
                {
                    "id": "bracing_section_type",
                    "label": "Bracing Section Type:",
        ...
        "Rolled Beam": {
            ...
            "section_inputs": [
                ...
                },
                {
                    ...
                    "label": "IS Section:",
                    "type": "combo_dynamic",
                    "dynamic_source": "rolled_sections",
        ...
        "Welded Beam": {
            ...
            "section_inputs": [
                ...
                },
                {
                    ...
                    "label": "Total Depth, d (mm):",
                    "type": "dimension",
                    "dimension_key": "total_depth",
                    "bind": "welded_total_depth",
                    "bind_widget": "welded_total_depth_widget",
                    "bind_bounds_button": "welded_total_depth_bounds_button",
                },
                {
                    "id": "web_thickness",
                    "label": "Web Thickness, w<sub>t</sub> (mm):",
                    ...
                    "bind_mode": "welded_web_thickness_combo",
                    "bind_value": "welded_web_thickness_value",
                    "bind_widget": "welded_web_thickness_widget",
                    "bind_value_combo": "welded_web_thickness_value_combo",
                    "value_width": 78,
                    "validator": {"type": "double", "bottom": 0, "top": 1000000, "decimals": 3},
                },
                {
                    "id": "top_width",
                    "label": "Width of Top Flange, t<sub>fw</sub> (mm):",
                    "type": "dimension",
                    "dimension_key": "top_width",
                    "bind": "welded_top_width",
                    "bind_widget": "welded_top_width_widget",
                    "bind_bounds_button": "welded_top_width_bounds_button",
                },
                {
                    "id": "top_thickness",
                    "label": "Top Flange Thickness, t<sub>ft</sub> (mm):",
                    "type": "mode_value",
                    "mode_choices": VALUES_PROFILE_SCOPE,
                    "bind_mode": "welded_top_thickness_combo",
                    "bind_value": "welded_top_thickness_value",
                    "bind_widget": "welded_top_thickness_widget",
                    "bind_value_combo": "welded_top_thickness_value_combo",
                    "value_width": 78,
                    "validator": {"type": "double", "bottom": 0, "top": 1000000, "decimals": 3},
                },
                {
                    ...
                    "label": "Width of Bottom Flange, b<sub>fw</sub> (mm):",
                    "type": "dimension",
                    "dimension_key": "bottom_width",
                    "bind": "welded_bottom_width",
                    "bind_widget": "welded_bottom_width_widget",
                    "bind_bounds_button": "welded_bottom_width_bounds_button",
                },
                {
                    "id": "bottom_thickness",
                    "label": "Bottom Flange Thickness, b<sub>ft</sub> (mm):",
                    "type": "mode_value",
                    "mode_choices": VALUES_PROFILE_SCOPE,
                    "bind_mode": "welded_bottom_thickness_combo",
                    "bind_value": "welded_bottom_thickness_value",
                    "bind_widget": "welded_bottom_thickness_widget",
                    "bind_value_combo": "welded_bottom_thickness_value_combo",
                    "value_width": 78,
                    "validator": {"type": "double", "bottom": 0, "top": 1000000, "decimals": 3},
                },
            ],
