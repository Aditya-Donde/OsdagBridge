...
class PlateGirderBridge:
    ...
    def _stage_load_combinations(self):
        ...
        self._store_load_combinations_report()
    ...
    def _store_load_combinations_report(self) -> None:
        """
        Build the authoritative load-combinations report (IRC6 defaults overlaid
        ...
        the default list. The expansion lives alongside the load-combination
        ...
        self.output_dict[KEY_ALL_LOAD_COMBINATIONS] = LoadCombinationWidget.build_load_combinations_report(
